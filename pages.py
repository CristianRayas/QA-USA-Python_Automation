...
class UrbanRoutesPage:
    ...
    BLANKET_SLIDER = (
        By.XPATH,
        '//div[contains(text(), "Blanket and handkerchiefs")]/ancestor::div[contains(@class, "r-sw")]//span[@class="slider round"]'
    )
    BLANKET_CHECKBOX = (
        By.XPATH,
        '//div[contains(text(), "Blanket and handkerchiefs")]/ancestor::div[contains(@class, "r-sw")]//input[@type="checkbox"]'
    )

    ICE_CREAM_PLUS_BUTTON = (
        By.XPATH,
        '//div[contains(text(), "Ice cream")]/ancestor::div[contains(@class, "r-counter")]//div[contains(@class, "counter-plus")]'
    )
    ICE_CREAM_COUNT = (
        By.XPATH,
        '//div[contains(text(), "Ice cream")]/ancestor::div[contains(@class, "r-counter")]//div[contains(@class, "counter-value")]'
    )
